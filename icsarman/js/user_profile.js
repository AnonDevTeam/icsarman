...
function change_password() {
	$.ajax({
		type: "POST",
		url: base_url+"/index.php/c_icsarman/c_edit_password/",
...
function change_email() {
	$.ajax({
		type: "POST",
		url: window.base_url+"/index.php/c_icsarman/c_edit_email/",
...
function change_add() {
	$.ajax({
		type: "POST",
		url: window.base_url+"/index.php/c_icsarman/c_edit_address/",
