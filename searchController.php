<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class SearchController extends CI_Controller{
		...
		function checkStudent(){
			...
			$res_material = $this->searchModel->checkReserveMaterial($user_id, $matId);
			$a = count($res_material);

			if($a != 0)
				echo "</br></br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspStudent Number ". $stdnum ." already reserved material id ".$matId;
			else{
